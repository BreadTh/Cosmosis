...
public interface ICosmosisQueryOrderedAfterDistinct<T>
{
    ICosmosisQueryOrderedAfterDistinct<T> ThenBy<TKey>(Expression<Func<T, TKey>> keySelector);
    ICosmosisQueryOrderedAfterDistinct<T> ThenByDescending<TKey>(Expression<Func<T, TKey>> keySelector);
    ...
    ICosmosisQueryOrderedAfterDistinct<T> Distinct();
    [Obsolete("OrderBy has already been applied. Use ThenBy for additional sort columns.", true)]
    ICosmosisQueryOrderedAfterDistinct<T> OrderBy<TKey>(Expression<Func<T, TKey>> keySelector);
    [Obsolete("OrderBy has already been applied. Use ThenByDescending for additional sort columns.", true)]
    ICosmosisQueryOrderedAfterDistinct<T> OrderByDescending<TKey>(Expression<Func<T, TKey>> keySelector);
