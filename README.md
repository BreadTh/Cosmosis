...
## About the author
I'm a software developer specializing in Azure and .NET with a focus on resilience patterns and data safety. Currently available for senior developer and hands-on architect roles in or near Copenhagen, Denmark. Please reach out at cosmosis@waitnostartover.com or check out my [CV](https://files.waitnostartover.com/CV) and [portfolio](https://files.waitnostartover.com/portfolio)
